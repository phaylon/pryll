...
test_all('arrays', $_test_ok,
    ...
    test_methods('filled array', '[2, 3, 4]',
        ...
        ['.unshift nothing', 'unshift', '!', [2, 3, 4]],
        ['.unshift nothing return', 'unshift', '', 0],
        ['.unshift single', 'unshift', '!(23)', [23, 2, 3, 4]],
        ['.unshift single return', 'unshift', '(23)', 1],
        ['.unshift multi', 'unshift', '!(7, 8)', [7, 8, 2, 3, 4]],
        ['.unshift multi return', 'unshift', '(7, 8)', 2],
    ),
